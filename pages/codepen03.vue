            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div>
                <h1 class="text-white font-semibold text-5xl">
                  Feel The <span class="text-orange-500">NEXT</span>
                </h1>
                <p class="mt-4 text-lg text-gray-300">
                  会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー会社のキャッチコピー
                </p>
                <a
                  href="#"
      ...
      <section id="about" class="relative py-20 bg-black text-white">
        <div class="container mx-auto px-4">
          <div class="items-center flex flex-wrap">
            ...
            >
              <div class="md:pr-12">
                <small class="text-orange-500">わたしたちについて</small>
                <h3 class="text-4xl uppercase font-bold">Safe Team Building</h3>
