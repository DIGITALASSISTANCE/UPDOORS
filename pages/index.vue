    ...
    <body class="text-gray-700 bg-white" style="font-family: 'Helvetica', sans-serif">
        ...
        <div class="bg-header flex items-center justify-center h-screen pb-12">
            <div class="container mx-auto px-6">
                ...
                <!--SP-->
            <div class="w-full bg-cover bg-center sm:hiden" style="height:18rem; background-image: url(https://images.unsplash.com/photo-1504384308090-c894fdcc538d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80);">
            </div>
